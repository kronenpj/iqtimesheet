...
public class TimeSheetDbAdapter {
	...
	protected Cursor getEntryReportCursor(boolean distinct, String[] columns,
		...
		try {
			...
			Log.d(TAG, "entryReport Cursor creation failed: " + e);
			return null;
		}
		if (mCursor != null) {
			mCursor.moveToLast();
	 ...
	 * 
	 * @param taskName
	 *            The name of the task to be deactivated.
	 */
	 ...
	 * 
	 * @param taskID
	 *            The ID of the task to be deactivated.
	 */
	 ...
	 * 
	 * @param taskName
	 *            The name of the task to be activated.
	 */
	 ...
	 * 
	 * @param taskID
	 *            The ID of the task's usage to be incremented.
	 */
	 ...
	 * @param values
	 *            the ContentValues being updated
	 * @param whereClause
	 *            clause to limit updates
	 * @param whereArgs
	 *            arguments to fill any ? in the whereClause.
