...
public class ReviveTaskTest extends
	...
	protected void setUp() throws Exception {
		...
		result = (ListView) solo
				.getView(com.github.kronenpj.iqtimesheet.IQTimeSheet.R.layout.tasklist);
	...
	public void test040reviveTask() {
		...
		solo.clickOnText(solo
				.getString(com.github.kronenpj.iqtimesheet.IQTimeSheet.R.string.menu_revive_task));
	}
	...
	public void test060retireTask() {
		...
		solo.clickOnText(solo
				.getString(com.github.kronenpj.iqtimesheet.IQTimeSheet.R.string.taskretire));
	}
